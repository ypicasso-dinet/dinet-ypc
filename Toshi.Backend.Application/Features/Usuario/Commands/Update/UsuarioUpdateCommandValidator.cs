...
{
    public class UsuarioUpdateCommandValidator : AppBaseValidator<UsuarioUpdateCommand>
    {
        public UsuarioUpdateCommandValidator()
        {
            RuleFor(r => r.id_usuario).Must(IsValidString).WithMessage("El ID de usuario es requerido");
