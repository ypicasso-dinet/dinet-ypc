...
{
    public class IngresoPolloUpdateCommandValidator : AppBaseValidator<IngresoPolloUpdateCommand>
    {
        public IngresoPolloUpdateCommandValidator()
        {
            RuleFor(r => r.id_ingreso_pollo).Must(IsValidString).WithMessage("El ID ingreso es requerido");
            //------------------------------------------------------------------------------------------------------------------------------------------
