...
{
    public class PersonalUpdateCommandValidator : AppBaseValidator<PersonalUpdateCommand>
    {
        public PersonalUpdateCommandValidator()
        {
            RuleFor(r => r.id_personal).Must(IsValidString).WithMessage("El ID es requerido");
